...
function TripCard({ trip, people, onViewDetails}) {
  ...
  // Generate trip suggestions using the API + calculations
    ...
    >
      ...
      <div className='bg-gradient-to-r from-teal-600 to-slate-600 dark:from-slate-700 dark:to-slate-800 p-4 sm:p-6 text-white transition-all duration-500 rounded-t-xl sm:rounded-t-2xl border-gray-200/50 dark:border-gray-700/50'>
        <div className='flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3 rounded-t-xl sm:rounded-t-2xl'>
          ...
          <TranslatedText
            text={trip.type}
            className={`text-xs sm:text-sm font-medium px-2 sm:px-3 py-1 rounded-full backdrop-blur-sm transition-all duration-300 flex-shrink-0 flex-shrink-0 break-words leading-tight ${
      ...
      <div className='p-4 sm:p-6 flex-1 flex flex-col'>
          ...
          <div className='mb-4 sm:mb-6 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg sm:rounded-xl border border-blue-200 dark:border-blue-800 transition-all duration-300 shadow-md'>
            ...
            <div className='grid grid-cols-2 gap-1 sm:gap-2'>
              <div className='text-center p-3 sm:p-4 bg-blue-100 dark:bg-blue-800/30 rounded-lg sm:rounded-xl border border-blue-300 dark:border-blue-700 transition-all duration-300'>
                <div className='text-lg sm:text-xl font-bold text-blue-700 dark:text-blue-300 break-words leading-tight whitespace-nowrap'>
                  {fmtBDT(Math.round(breakdown.total))}
                </div>
                <TranslatedText
                  text='Total Cost'
              ...
              <div className='text-center p-3 sm:p-4 bg-green-100 dark:bg-green-800/30 rounded-lg sm:rounded-xl border border-green-300 dark:border-green-700 transition-all duration-300'>
                <div className='text-lg sm:text-xl font-bold text-green-700 dark:text-green-300 break-words leading-tight whitespace-nowrap'>
        ...
        <div className='mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-600 transition-all duration-300 shadow-md'>
          ...
          {trip?.gpstarOffers?.extras &&
            trip.gpstarOffers.extras.length > 0 && (
              <>
                <TranslatedText
                  text='GPStar Perks'
        ...
        <button
          ...
          className='md:hidden text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-xs sm:text-sm font-medium mb-3 sm:mb-4 transition-all duration-300 cursor-pointer font-inter'
        >
          <TranslatedText
        ...
        {showItinerary && (
          <>
            <button
              ...
              className='hidden lg:block text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-xs sm:text-sm font-medium mb-3 sm:mb-4 transition-all duration-300 cursor-pointer font-inter'
            >
              <TranslatedText
                text={showBreakdown ? "Hide Details" : "Show Details"}
              />
            </button>
            {/* Itinerary - Always visible on mobile, hidden on desktop */}
                ...
                <div className='space-y-3'>
                  ...
                  <div className='relative group/flight'>
                    <div className='flex justify-between text-xs sm:text-sm mb-1'>
                      ...
                      />
                      <span className='font-semibold text-blue-800 dark:text-blue-200 break-words leading-tight whitespace-nowrap'>
                        {fmtBDT(Math.round(breakdown.flight))}
                      </span>
                    </div>
                    <div className='w-full bg-blue-200 dark:bg-blue-700 rounded-full h-2 group-hover/flight:bg-blue-300 dark:group-hover/flight:bg-blue-600 transition-all duration-300'>
                      <div
                        ...
                        style={{
                          width: `${
                            (breakdown.flight / breakdown.total) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
               ...
               '
                  ...
                  <div className='relative group/hotel'>
                    <div className='flex justify-between text-xs sm:text-sm mb-1'>
                      ...
                      />
                      <span className='font-semibold text-green-800 dark:text-green-200 break-words leading-tight whitespace-nowrap'>
                        {fmtBDT(Math.round(breakdown.hotel))}
                      </span>
                    </div>
                    <div className='w-full bg-green-200 dark:bg-green-700 rounded-full h-2 group-hover/hotel:bg-green-300 dark:group-hover/hotel:bg-green-600 transition-all duration-300'>
                      <div
                        ...
                        style={{
                          width: `${
                            (breakdown.hotel / breakdown.total) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
                ...
                '
                  ...
                  <div className='relative group/activities'>
                    <div className='flex justify-between text-xs sm:text-sm mb-1'>
                      ...
                      />
                      <span className='font-semibold text-purple-800 dark:text-purple-200 break-words leading-tight whitespace-nowrap'>
                        {fmtBDT(Math.round(breakdown.activities))}
                      </span>
                    </div>
                ...
                '
                  ...
                  <div className='relative group/transport'>
                    <div className='flex justify-between text-xs sm:text-sm mb-1'>
                      ...
                      />
                      <span className='font-semibold text-orange-800 dark:text-orange-200 break-words leading-tight whitespace-nowrap'>
                        {fmtBDT(Math.round(breakdown.transport))}
                      </span>
                    </div>
                ...
                '
                  ...
                  <div className='relative group/contingency'>
                    <div className='flex justify-between text-xs sm:text-sm mb-1'>
                      ...
                      />
                      <span className='font-semibold text-red-800 dark:text-red-200 break-words leading-tight whitespace-nowrap'>
                        {fmtBDT(Math.round(breakdown.contingency))}
                      </span>
                    </div>
            ...
            {/* Button and Download Options - Always visible */}
            <div className='mt-auto pt-3 sm:pt-4'>
              <TranslatedButton
                onClick={() => onViewDetails(trip)}
                normalText='Learn More'
                isLoading={false}
            ...
            <div className='mt-4'>
              <TripDownloadOptions trip={trip} people={people} />
            </div>
          </>
        )}
      </div>
