    ...
    <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:scale-[1.02] h-full flex flex-col group">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-slate-600 dark:from-slate-700 dark:to-slate-800 p-4 sm:p-6 text-white transition-all duration-500">
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
          <h3 className="text-lg sm:text-xl font-bold transition-all duration-300 font-telenor flex-1 min-w-0 truncate">{option.name}</h3>
          <span className={`text-xs sm:text-sm font-medium px-2 sm:px-3 py-1 rounded-full backdrop-blur-sm transition-all duration-300 flex-shrink-0 whitespace-nowrap ${
        ...
        <p className="text-teal-100 dark:text-slate-200 text-xs sm:text-sm opacity-90 transition-all duration-300 font-inter">{option.stay}</p>
        {option.nights > 0 && (
      ...
      <div className="p-4 sm:p-6 flex-1 flex flex-col">
        ...
        <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-600 transition-all duration-300 shadow-md">
          <div className="font-semibold mb-2 sm:mb-3 text-xs sm:text-sm text-gray-800 dark:text-gray-200 font-telenor">Highlights</div>
          ...
          {option.gpstarOffers?.extras && (
            <>
              <div className="font-semibold mb-2 mt-3 sm:mt-4 text-xs sm:text-sm text-gray-800 dark:text-gray-200 font-telenor">GPStar Perks</div>
              <ul className="list-disc list-inside space-y-1 text-xs sm:text-sm font-inter">
        ...
        {/* Itinerary section */}
        <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-600 transition-all duration-300 shadow-md">
          <div className="font-semibold mb-2 sm:mb-3 text-xs sm:text-sm text-gray-800 dark:text-gray-200 font-telenor">Sample Itinerary</div>
        ...
        {(breakdown.savingsFlight > 0 || breakdown.savingsHotel > 0) && (
          <div className="mb-4 sm:mb-6 p-2 sm:p-3 bg-green-50 dark:bg-green-900/20 rounded-lg sm:rounded-xl border border-green-200 dark:border-green-800 transition-all duration-300 shadow-md">
            <div className="text-center">
              <div className="text-base sm:text-lg font-bold text-green-700 dark:text-green-400 font-telenor">
                GPStar Savings!
              </div>
