...
function BudgetForm({ budgetBDT, setBudgetBDT, people, setPeople, onGenerate, isLoading }) {
  return (
    <div className="animate-fade-in bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200/50 dark:border-gray-700/50 mb-8 hover:shadow-2xl transition-all duration-500">
      <h1 className="text-3xl sm:text-4xl font-bold text-center mb-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent animate-fade-in">
        GP Trip Planner
      </h1>
      <p className="text-gray-600 dark:text-gray-300 text-center mb-8 text-sm sm:text-base animate-fade-in" style={{animationDelay: '200ms'}}>
