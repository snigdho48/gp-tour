      ...
      <div className="flex flex-col sm:flex-row items-center justify-center mb-3 sm:mb-4 gap-2 sm:gap-3">
        <img src={logo} alt="GPStar Logo" className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />
           ...
           <TranslatedText
             text='GPStar'
             as='span'
             className='text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold bg-gradient-to-r from-[#00B5FB] to-[#3cbef2] bg-clip-text text-transparent font-telenor'
           />
           <TranslatedText
             text='Trip Planner'
             className='text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold bg-gradient-to-r from-[#00B5FB] to-[#3cbef2] bg-clip-text text-transparent font-telenor'
         ...
         className='text-gray-600 dark:text-gray-300 text-center mb-6 sm:mb-8 text-xs sm:text-sm lg:text-base font-inter'
         as='p'
       />
